...
(function (HomeAutomation) {
    var Me;
    (function (Me) {
        var HomeAutoControlPage;
        (function (HomeAutoControlPage_1) {
            class HomeAutoControlPage {
                constructor($scope) {
                    this.scope = $scope;
                    var self = this;
            ...
            HomeAutoControlPage.$inject = ["$scope"];
            HomeAutoControlPage_1.HomeAutoControlPage = HomeAutoControlPage;
        })(HomeAutoControlPage = Me.HomeAutoControlPage || (Me.HomeAutoControlPage = {}));
...
//# sourceMappingURL=home-automation-control.js.map