...
{
    [Route("v1.0/stock"), Authorize(Roles = "Device,Admin,User,Agent")]
    [ApiController]
    public partial class StockController : ControllerBase
    {
        ...
        public StockController(IHubContext<AdminToolsHub> adminContext, IHubContext<AppAndDeviceHub> appContext, IHubContext<SystemHub> sysContext)
        {
